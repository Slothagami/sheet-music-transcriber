...
function reset(e) {
    ...
    if(e.key == "s") {
        ...
        let note = pressed_notes()[0].replaceAll("#", "").replaceAll("b", "")
        let note_brightness = note_strength(note).total
        let text = `${id}, ${keywidth}, ${note_brightness}, ${window_pixel(100)}, true, 88`
